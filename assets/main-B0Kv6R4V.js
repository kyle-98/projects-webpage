import{_ as Y,c as a,o as r,a as p,B as j,s as Ie,b as re,d as se,e as A,f as $e,g as D,r as $,m as s,h as u,i as m,j as d,n as S,k as Se,l as _,p as x,t as v,q as xe,u as Ce,v as we,w as Le,x as Fe,y as Te,z as Ve,A as Ae,C as Pe,R as Me,D as T,E as Ke,F as De,G as Ee,H as N,I as ze,J as Be,K as Re,L as je,M as Ge,N as He,Z as W,O as Ne,P as V,Q as Ue,S as qe,T as Je,U as We,V as M,W as Qe,X as I,Y as w,$ as K,a0 as U,a1 as O,a2 as Ze,a3 as Xe,a4 as Ye,a5 as _e,a6 as Q,a7 as et,a8 as ee,a9 as te,aa as tt,ab as nt,ac as it,ad as ot}from"./main-a7G_3SeK.js";const lt={},rt={class:"title-section"};function st(e,t){return r(),a("section",rt,t[0]||(t[0]=[p("h1",null,"Kyle's Projects",-1),p("p",null,"We are indeed moomin",-1)]))}const at=Y(lt,[["render",st],["__scopeId","data-v-1eb82ed2"]]);var ct=({dt:e})=>`
.p-checkbox {
    position: relative;
    display: inline-flex;
    user-select: none;
...
`,wt={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},Lt=j.extend({name:"chip",style:Ct,classes:wt}),Ft={name:"BaseChip",extends:_,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:Lt,provide:function(){return{$pcChip:this,$parentInstance:this}}},de={name:"Chip",extends:Ft,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(t){(t.key==="Enter"||t.key==="Backspace")&&this.close(t)},close:function(t){this.visible=!1,this.$emit("remove",t)}},computed:{dataP:function(){return A({removable:this.removable})}},components:{TimesCircleIcon:ce}},Tt=["aria-label","data-p"],Vt=["src"];function At(e,t,n,o,l,i){return l.visible?(r(),a("div",s({key:0,class:e.cx("root"),"aria-label":e.label},e.ptmi("root"),{"data-p":i.dataP}),[u(e.$slots,"default",{},function(){return[e.image?(r(),a("img",s({key:0,src:e.image},e.ptm("image"),{class:e.cx("image")}),null,16,Vt)):e.$slots.icon?(r(),m(x(e.$slots.icon),s({key:1,class:e.cx("icon")},e.ptm("icon")),null,16,["class"])):e.icon?(r(),a("span",s({key:2,class:[e.cx("icon"),e.icon]},e.ptm("icon")),null,16)):d("",!0),e.label?(r(),a("div",s({key:3,class:e.cx("label")},e.ptm("label")),v(e.label),17)):d("",!0)]}),e.removable?u(e.$slots,"removeicon",{key:0,removeCallback:i.close,keydownCallback:i.onKeydown},function(){return[(r(),m(x(e.removeIcon?"span":"TimesCircleIcon"),s({class:[e.cx("removeIcon"),e.removeIcon],onClick:i.close,onKeydown:i.onKeydown},e.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):d("",!0)],16,Tt)):d("",!0)}de.render=At;var Pt=({dt:e})=>`
.p-multiselect {
    display: inline-flex;
    cursor: pointer;
    position: relative;
